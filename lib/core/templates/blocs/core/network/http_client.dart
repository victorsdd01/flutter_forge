...
import 'package:{{project_name}}/core/enums/server_status.dart';
import 'package:{{project_name}}/core/utils/shared_preference_utils.dart';
...
class HttpClient {
  ...
  Future<String?> getToken() async => await Injector.get<SharedPreferencesUtils>().getString('accessToken');

  Future<String?> refreshToken() async {
    final String? currentRefreshToken = await Injector.get<SharedPreferencesUtils>().getString('refreshToken');
    ...
    try {
      ...
      await Injector.get<SharedPreferencesUtils>().setString('accessToken', newAccessToken);
      
      if (newRefreshToken != null && newRefreshToken.isNotEmpty) {
        await Injector.get<SharedPreferencesUtils>().setString('refreshToken', newRefreshToken);
      }
